...
namespace AnimationSample.Controls
{
    public class TouchHighlightImageButton : ImageButton
    {
        ...
        public TouchHighlightImageButton(Context context) : this(context, null)
        {
        }

        public TouchHighlightImageButton(Context context, IAttributeSet attrs) : this(context, attrs, 0)
        {
        }

        public TouchHighlightImageButton(Context context, IAttributeSet attrs, int defStyle) : base(context, attrs, defStyle)
        {
            Init();
        }
