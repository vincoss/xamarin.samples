...
{
    [Activity(Label = "Calendar Samples", MainLauncher = true, Icon = "@drawable/icon")]
    public class MainActivity : ListActivity
    {
        ...
        public MainActivity()
        {
            ...
            _menuService.Add("Calendar List", typeof (OneActivity))
                        .Add("Calendar Event List", typeof (TwoActivity));
        }
