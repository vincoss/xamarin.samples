...
namespace AnimationSample
{
    public class KarmaMeter : View
    {
        ...
        public KarmaMeter(Context context, IAttributeSet attrs) : this(context, attrs, 0)
        {
            Initialize();
        }

        public KarmaMeter(Context context, IAttributeSet attrs, int defStyle) : base(context, attrs, defStyle)
        {
            Initialize();
        }
