...
namespace AudioSamples
{
    ...
    public class AudioActivity : Activity
    {
        ...
        AudioNotificationManager nMan = new AudioNotificationManager();
        ...
        protected override void OnCreate(Bundle bundle)
        {
            ...
            AudioNotificationManager.audioManager = (AudioManager)GetSystemService(Context.AudioService);
            ...
            AudioNotificationManager.MainActivity = this;
            activity = this;
        }
