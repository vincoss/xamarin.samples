...
[assembly: ExportEffect(typeof(SkiaSharp_Samples.Custom.TouchEffect), "TouchEffect")]

namespace SkiaSharp_Samples.Custom
{
    public class TouchEffect : PlatformEffect
    {
        Android.Views.View view;
        Element formsElement;
        SkiaSharp_Samples.Xaml.TouchEffect libTouchEffect;
        bool capture;
        ...
        protected override void OnAttached()
        {
            ...
            SkiaSharp_Samples.Xaml.TouchEffect touchEffect =
                (SkiaSharp_Samples.Xaml.TouchEffect)Element.Effects.
