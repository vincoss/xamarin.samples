...
namespace WebAuthenticatorSamples
{
    ...
    {
        public const string ClientId = "TODO: clientId"; //App key
        public const string TenantId = "TODO: tenantId";
        public static string AuthorityUrl = $"https://login.microsoftonline.com/{TenantId}/oauth2/authorize";
        public const string RedirectUri = "com.companyname.webauthenticatorsamples://oauth2redirect";
        public const string ResponseType = "code";
        public const string Scope = "openid";
    }
